      ...
      try {
        ...
        switch (payload.cmd) {
          ...
          case 'auth_req':
            ...
            if (account) {
              let auth_key: string | undefined = undefined;
              ...
              if (auth_key) {
                try {
                  ...
                  if (auth_req_data.challenge) {
                    ...
                    assert(
                      challenge_data.key_type &&
                        ...
                        KEY_TYPES.includes(challenge_data.key_type),
                      'invalid payload (challenge_data.key_type)'
                    );
                    assert(
                      challenge_data.challenge &&
                        typeof challenge_data.challenge == 'string',
                  ...
                  if (approve) {
                    ...
                    if (hasStorageStore.auth_req_reject) {
              ...
              try {
                ...
                assert(
                  sign_req_data.key_type &&
                    ...
                    KEY_TYPES.includes(sign_req_data.key_type),
                  'invalid data (key_type)'
                );
                assert(
                  sign_req_data.ops && sign_req_data.ops.length > 0,
                  'invalid data (ops)'
                );
                assert(
                  sign_req_data.broadcast != undefined,
                  'invalid data (broadcast)'
                );
